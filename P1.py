...
#import sklearn.model_selection.learning_curve
...
print("A look at the data");df[:10] #idhar yeh df[:10] ka output kyu nahi aa rha
print("A look at the features as well"); features #ab yeh bhi nahi aa rha lagta hai Jupyter mei kuch limitation hoga
...
one.hist(df['RM'], bins = 30)  #using bins=30 here instead of bin=15 for experimental basis iska bhi puch lena
...
#score = func([3, -0.5, 2, 7, 4.2], [2.5, 0.0, 2.1, 7.8, 5.3])
